...
import LOGIN_JWT_MUTATION from "@/gql/mutations/loginJwt"; // Import the actual mutation
import LOGIN_MUTATION from "@/gql/mutations/login"; // Import the actual mutation
